    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => WordCollection(
          ...
          dictionaryId: wordCollectionData.dictionaryId,
        ),
      ),
    );
  }
  ...
  void initDictionaries() {
    ...
    if (dictionaries.isEmpty) {
      ...
      db.write(() {
        ...
        db.all<WordCollectionData>().forEach((wordCollection) {
          wordCollection.dictionaryId = dictionaryId;
        });
      });
    }
  }
...
class CreateWordTableButton extends StatelessWidget {
        ...
        showDialog(
          ...
          builder: (context) {
            return WordCollectionCreator(
              ...
              onCreate: (String name, Dictionary dictionary, int wordCount) {
                var wordCollectionData = WordCollectionData(
                  name,
                  DateTime.now(),
                  dictionary.id,
                  words: getRandomWords(dictionary, wordCount),
                );
  ...
  List<String> getRandomWords(Dictionary dictionary, int count) {
    List<String> all = [];
    var entries =
