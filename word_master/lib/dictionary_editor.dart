...
class _DictionaryEditorState extends State<DictionaryEditor> {
  ...
  Widget build(BuildContext context) {
    var isDictionaryImported = false;
    try {
      widget.db
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Editing Dictionary "${widget.dictionary.name}"'),
      ),
      body: Center(
        child: _buildEntriesList(isDictionaryImported),
      ),
  ...
  Widget _buildEntriesList(bool isDictionaryImported) {
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            return Padding(
              ...
              child: _buildEntry(entries![index], isDictionaryImported),
            );
          },
        );
      },
  ...
  Widget _buildEntry(DictionaryEntry entry, bool isDictionaryImported) {
    return Dismissible(
